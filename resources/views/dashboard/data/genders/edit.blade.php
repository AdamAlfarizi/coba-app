...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Edit Jenis Kelamin</h1>
    </div>

    <div class="col-lg-8">
        <form method="post" action="/dashboard/data/genders/{{ $gender->id }}" class="mb-5"
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('jenis') is-invalid @enderror" id="jenis" name="jenis" required
                    autofocus value="{{ old('jenis', $gender->jenis) }}">
                @error('jenis')
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control @error('jumlah') is-invalid @enderror" id="jumlah" name="jumlah"
                    required value="{{ old('jumlah', $gender->jumlah) }}">
                @error('jumlah')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <button type="submit" class="btn btn-primary">Update Jenis Kelamin</button>
        </form>
    </div>
