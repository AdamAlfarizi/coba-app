        ...
        <form method="post" action="/dashboard/data/marriages/{{ $marriage->id }}" class="mb-5"
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('status') is-invalid @enderror" id="status" name="status"
                    required autofocus value="{{ old('status', $marriage->status) }}">
                @error('status')
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control @error('jumlah') is-invalid @enderror" id="jumlah" name="jumlah"
                    required value="{{ old('jumlah', $marriage->jumlah) }}">
                @error('jumlah')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <button type="submit" class="btn btn-primary">Update Penddidikan</button>
        </form>
    </div>
