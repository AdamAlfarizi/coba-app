        ...
        <div class="card">
            <div class="card-body">
                <div class="card-header">
                    <h4>Chart Perkawinan</h4>
                </div>
                <div id="chart-profile-visit"></div>
            </div>
            <div class="card-header text-center">
                <h4>Table Perkawinan</h4>
            </div>
            <div>
                <a href="/dashboard/data/marriages/create" class="btn btn-primary mb-3">Careate New Status</a>
            </div>
                    ...
                    <tbody>
                        @foreach ($marriage as $marriag)
                            <tr>
                                ...
                                <td>{{ $marriag->jumlah }}</td>
                                <td>
                                    <a href="/dashboard/data/marriages/{{ $marriag->id }}/edit"
