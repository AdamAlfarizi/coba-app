...
@section('container')
    ...
    <div class="row mb-5 py-3">
        <div class="col-lg-8">
            <h2 mb-3> {{ $keramaian->nama_pengaju }} </h2>
            <div class="mb-3">
                <a href="/dashboard/villages/" class="btn btn-success"> <span data-feather="arrow-left"></span> Back </a>
                <a href="/dashboard/villages/{{ $keramaian->slug }}/edit" class="btn btn-warning"> <span
                        data-feather="edit"></span>
                    Edit</a>
                <form action="//dashboard/villages/{{ $keramaian->slug }}" method="post" class="d-inline">
                    @method('delete')
                    @csrf
                            ...
                            <tr>
                                ...
                                <td> :
                                    <img src="{{ asset('storage/' . $keramaian->image1) }}"
                                        alt="{{ $keramaian->image1 }}" class="aparaturs">
                                </td>
                            </tr>
                            <tr>
                                <td>Jenis Usadha</td>
                                <td>
                                    ...
                                    <img src="{{ asset('storage/' . $keramaian->image2) }}"
                                        alt="{{ $keramaian->image2 }}" class="aparaturs">
                                </td>
                            </tr>
                        </thead>
                    </table>
