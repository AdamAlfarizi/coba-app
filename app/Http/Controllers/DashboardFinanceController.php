...
class DashboardFinanceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/dashboard/finances')->with('success', 'New Finance has been added!');
    }
    ...
    public function update(Request $request,Finance $finance)
    {
        ...
        return redirect('/dashboard/finances')->with('success', 'Info Keuangan has been updated!');
    }
    ...
    public function destroy(Finance $finance)
    {
        ...
        return redirect('/dashboard/finances')->with('success', 'Info Keuangan has been added!');
    }
}
